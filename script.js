...
const GhostCoinsAddress = "0x946fEC95a14CE91178cd21819E9910f05D964d77";
const GhostBadgesAddress = "0xB81668c2599be7Ab44aF2b2B481E6189Ab5d9AD7";
const GhostCoinsAbi = [
	{
		"inputs": [],
		...
		"outputs": [
			{
				...
				"internalType": "struct GhostCoins.Registered_org[]",
				"name": "",
				"type": "tuple[]"
			}
		],
...
const GhostBadgeAbi = [
	...
	},
	{
		...
		"outputs": [
			{
				"internalType": "contract GhostCoins",
				"name": "",
				"type": "address"
			}
		],
...
document.getElementById('connectWallet').onclick = async() => {
    ...
    contract = new ethers.Contract(GhostCoinsAddress, GhostCoinsAbi, signer);
    NftContract = new ethers.Contract(GhostBadgesAddress, GhostBadgeAbi, signer);
...
document.getElementById("getScore").addEventListener("click",async ()=>{
	let score = await contract.get_score(); // Await the asynchronous call
        console.log(balance.toString());
		document.getElementById("getScore").innerText=`Score : ${score}`
       
})

document.getElementById("getNft").addEventListener("click",async ()=>{
	let tx = await NftContract.mintNFT(); // Await the asynchronous call
    tx.wait();
	alert(`nft minted id: ${tx}`);  
